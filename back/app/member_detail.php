...
class member_detail extends Model
{
    ...
    protected $fillable = [
        'member_id', 'dependents_no', 'children_no', 'household_no', 'spouse_name', 'spouse_age', 'spouse_occupation',
        ...
        'emp_position', 'emp_date_employed', 'emp_gross', 'emp_currency', 'emp_annual', 'emp_occ_status', 'bn_name', 'bn_nature',
        'bn_established', 'bn_tin', 'bn_address', 'bn_contact'
    ];
}
