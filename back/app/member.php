...
class member extends Model
{
    protected $fillable = [
        ...
        'membership_type_id', 'application_status', 'membership_status', 'present_residential', 'monthly_present', 'occupied_present', 'last_update_present', 'last_update_permanent',
        ...
        'height', 'weight', 'approval_date', 'enrollment_date', 'street', 'barangay', 'city', 'country', 'postal_code'
    ];
